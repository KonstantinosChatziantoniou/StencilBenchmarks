...
__global__ void nv_32_4(float* g_input, float* g_output, // float* g_vsg, = 1
...
float* nvidiaStencil_32_4(float* data, int dimx, int dimy, int dimz){
    ...
    nv_32_4<<<blocks,threads>>>(dev_data, dev_out, dimx,dimy, dimz);
